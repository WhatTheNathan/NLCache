...
//        _type = type
//        _path = path
//        _dataPath = path.appending(dataDirectoryName)
//        _trashPath = path.appending(trashDirectoryName)
//        _dbPath = path.appending(dbFileName)
...
//        let uuid = UUID.init()
//        let tempPath = _trashPath + String(uuid)
//        var isSuccess = true
//        do {
...
//        trashQueue.async {
//            let directoryContents = FileManager.default.contentsOfDirectory(atPath: _trashPath)
//            for path in directoryContents {
//                let fullPath = _trashPath + path
//                do {
